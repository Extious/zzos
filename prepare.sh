...
apt-get install -y libopts25 libselinux1-dev libopts25-dev libfont-freetype-perl libfreetype6-dev libtool libfuse3-3 liblzma5 libdevmapper-dev libelf-dev
